...
| _this commit_ | P-RC-4 P4.15b | refactor(core): replace core/context_manager.py body with thin import shim | core/context_manager.py 1799->36 (lazy __getattr__ re-export); agent/context.py imports updated to use _context_manager_legacy | 0 | ADR-0001 |

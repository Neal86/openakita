...
> **Sub-phase status (2026-05-19, P9.3c in-flight)**: P9.0 closed, P9.1 closed (Nit-3 of 5 cleared; 4 ride to G-RC-9), P9.2 closed (parity 6/6, contract 36/36), P9.3 NodeScheduler in progress (P9.3a0/a/b ship the v2 surface; P9.3c lights up 4 parity fixtures; contract tests in P9.3d).

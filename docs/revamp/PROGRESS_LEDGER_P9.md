...
| _this commit_ | P-RC-9 P9.1c | test(parity/orgs): activate 8 blackboard parity fixtures (xfail -> pass) | +230 (test_blackboard_parity.py REPLACE: 18-line xfail placeholder -> 228-line fixture suite) | +8 / -1 xfail (placeholder removed; 8 real fixtures pass) | ADR-0011 (parity gates the rewrite); ADR-0013 (concurrent-write fixture is the in-process precursor to P9.4 wall-clock SLA) |

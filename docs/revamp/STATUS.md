...
| P-RC-8 — Endgame (audit nits + docs + ADR flip + acceptance + release tag) | **In progress (P8.0..P8.5 landed; G-RC-8 + tag pending)** | 5 so far (P8.0 nits + P8.2 ADR flip + P8.3 ACCEPTANCE + P8.4 P-RC-9 charter + P8.5 RELEASE_v2 rc2 section) | 1123 / 1123 + 1 skipped + 5 xfailed (+1 brain smoke vs P-RC-7) |

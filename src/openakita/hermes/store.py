    ...
    def _read_unlocked(self) -> list[HermesNode]:
        ...
        for row in raw_rows:
            ...
            try:
                ...
                # String normalization can raise AttributeError and numeric
                # coercion can raise OverflowError (for example JSON Infinity).
                # Neither should hide otherwise-valid Hermes nodes.
                continue
        return nodes
